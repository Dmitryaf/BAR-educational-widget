...
function widget:Initialize()
	...
	harness.run(SPEC_ROOT .. "opening_context_spec.lua")
	harness.run(SPEC_ROOT .. "opening_progress_spec.lua")
	harness.run(SPEC_ROOT .. "coach_presentation_spec.lua")
	...
	harness.run(SPEC_ROOT .. "replay_observation_spec.lua")
	harness.run(SPEC_ROOT .. "replay_analysis_spec.lua")
	harness.run(SPEC_ROOT .. "replay_widget_contract_spec.lua")
